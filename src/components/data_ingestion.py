...
class DataIngestion:
    def __init__(self):
        self.data_ingestion_config = dataIngestionCongi()
...
#     train_arr, test_arr , processed_obj_file_path= data_transformation.inititate_data_transformation(train_data, test_data)
#
# # Data Transformation
# if __name__ == "__main__":
#     obj = DataIngestion()
